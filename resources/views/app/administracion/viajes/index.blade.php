        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden">
                <div class="my-2 flex items-center justify-between">
                    <form class="block relative" method="get" action="{{ route('viajes') }}">
                    ...
                    <a href="{{ route('viajes.create') }}" class="flex items-center bg-yellow-500 hover:bg-yellow-600 text-white rounded shadow-lg px-4 py-2">
                                    ...
                                    <tr>
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <p class="date-gray-900 whitespace-no-wrap capitalize">
                                        ...
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <p class="time-gray-900 whitespace-no-wrap capitalize">
                                                    {{ $viaje->hora }}
                                                </p>
                                            </div>
                                        </td>  
                                        ...
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">{{ $viaje->origen }}</p>
                                        </td>
                                        
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">{{ $viaje->destino }}</p>
                                        </td>
                                       {{--
                                        <!--
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                            @if ( $viaje->estado == 'disponible' )
                                                <span class="bg-green-300 text-green-700 px-3 py-1 rounded-full">Disponible</span>
                                            @else
                                                <span class="bg-red-300 text-red-700 px-3 py-1 rounded-full">No disponible</span>
                                            @endif
                                        </td>
                                    BUS
                                        <td class="px-5 py-3 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <a href="{{ route('viajes.show', $viaje->id) }}" title="ver mas informacion de viaje" class="flex items-center text-gray-400 hover:text-gray-700">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                            </a>
                                            
                                            <a href="{{ route('viajes.edit', $viaje->id) }}" title="editar viaje" class="flex items-center text-gray-400 hover:text-gray-700">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                            </a>
                                            {{--
                                            @if($viaje->controlarventas->count() < 1) 
                                            <form method="post" action="{{ route('viajes.delete', $viaje->id) }}">
                                                @method('delete')
                                                {{ csrf_field() }} 

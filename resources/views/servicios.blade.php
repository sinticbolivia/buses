      ...
      <div class="container mx-auto px-8">
          <header class="flex flex-col sm:flex-row items-center justify-between py-6 relative">
              ...
              <nav class="hidden md:flex text-lg">
                  <a href="#" class="text-gray-800 hover:text-purple-300 py-3 px-6">Inicio</a>
                  <a href="{{ route('servicios') }}" class="text-gray-800 hover:text-purple-300 py-3 px-6">Servicios</a>
                  <a href="about.html" class="text-gray-800 hover:text-purple-300 py-3 px-6">Acerca</a>
                  <a href="contact us.html" class="text-gray-800 hover:text-purple-300 py-3 px-6">Contactos</a>
                  <a href="{{ route('login') }}" class="text-gray-800 hover:text-purple-300 py-3 px-6">Iniciar Sesion</a>
                  <a href="{{ url('/register') }}"  class="text-gray-800 hover:text-purple-300 py-3 px-6">Registrate</a>
              </nav>
          ...
          <main class="flex flex-col-reverse sm:flex-row jusitfy-between items-center py-12">
              <div class="sm:w-2/5 flex flex-col items-center sm:items-start text-center sm:text-left">
                  <h1 class="uppercase text-6xl text-purple-900 font-bold leading-none tracking-wide mb-2">Expreso Tarija</h1>
              ...
              <h1>ofrecemos muy buenos servicios </h1>
              <div class="mb-16 sm:mb-0 mt-8 sm:mt-0 sm:w-3/5 sm:pl-12">
                  <img src="{{ asset('imagen/bus.png') }}" class="w-full" alt="">
              </div>
          </main>
      </div>
  </div>
...
<footer class="text-gray-600 body-font">
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
      <img src="https://upload.wikimedia.org/wikipedia/commons/1/19/Digital_Marketing_logo.png" width="40" height="2">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021
      <a href="https://twitter.com/knyttneve" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@expresotarija</a>
    </p>

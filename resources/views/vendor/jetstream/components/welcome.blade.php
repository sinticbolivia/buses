<div class="p-6 sm:px-20 bg-yellow-500 border-b border-gray-200">
    
    <div class="mt-8 text-2xl">
        EMPRESA DE TRANSPORTE EXPRESO TARIJA
    </div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Documentation</a></div>
        </div>
    </div>
</div>
<!--

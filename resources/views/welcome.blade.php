...
<a href="https://api.whatsapp.com/send?phone=+59163712157&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n?" class="float" target="_blank">
<i class="fa fa-whatsapp my-float"></i>
    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <img class="text-1xl font-bold uppercase text-purple-100 h-20 w-20 rounded-full" src="{{ asset('imagen/bus2.jpg') }}"  width="20" height="50"></img>
            
            <nav id="nav"
                class="absolute top-0 left-0 z-50 flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
                <a href="#"
                    class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Inicio</a>
                
                <a href="#rutas"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Rutas</a>
                <a href="#servicios"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Servicios</a>              
                <a href="{{ url('/departure') }}"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Compre tu Boleto aqui!
                </a>
            </nav>
            <div
                class="absolute left-0 flex-col items-center justify-center hidden w-full pb-8 mt-48 border-b border-gray-200 md:relative md:w-auto md:bg-transparent md:border-none md:mt-0 md:flex-row md:p-0 md:items-end md:flex md:justify-between">
                <a href="{{ route('login') }}"
                    class="relative z-40 px-3 py-1 mr-0 text-sm font-bold text-pink-500 md:px-5 lg:text-white sm:mr-3 md:mt-0">Iniciar Sesion</a>
                <a href="{{ url('/register') }}"
                    class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Registrate
                </a>
                ...
                <svg class="absolute top-0 left-0 hidden w-screen max-w-3xl -mt-64 -ml-12 lg:block"
                    ...
                    <defs>
                        <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="c">
                            <stop stop-color="#EA8328" offset="0%" />
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-blue-700 sm:text-4xl xl:mb-8 font-mono">Empresa de Transporte <br> Expreso Tarija</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
                Transporte Expreso Tarija es una empresa que se encarga de transportar pasajeros y carga de la manera mas segura y confortable generando su confianza.
                </p>
                <a href="{{ url('/register') }}"
                    class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-indigo-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Regístrate 
                    hoy</a>
            ...
            <div  class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                <div class=" containerrelative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">

                    <img src="imagen/inicio.jpeg" 
                    height="900" width="800" class=" mt-20 mb-20 ml-0 lg:mt-24 xl:mt-50 lg:mb-0 lg:h-80 lg:-ml-1 shadow-2xl">
    ...
    <div id="rutas" class="slider relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-2 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            <h3
                class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">
                NUESTRAS RUTAS</h3>
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">POTOSI, CAMARGO, TARIJA</h2>
            
            <ul class="relative w-full" >
                <li>
                    <img src="imagen/foto4.jpg" height="200" width="150"> 
                </li>
                <li>
                    <img src="imagen/foto1.jpeg" height="300" width="150">
                </li>
                <li>
                    <img src="imagen/foto5.jpeg" height="300" width="150">
                </li>     
            </ul>
                <!--
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20"> arriba de ul
                    
                    <div  id="features" class=" slider flex justify-between relative py-1 border-t border-gray-200 md:py-16 lg:py-24 xl:py-4 xl:px-0">
                    <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
                            <h3
                                class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">
                                NUESTRAS RUTAS</h3>
                                ...
                                <ul class="relative w-full" >
                                    <li><img src="imagen/foto.jpeg" height="300" width="150"> 
                
                                        <div class="centrado max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">De Potosi</div></li>
                                    <li><img src="imagen/foto.jpeg" height="300" width="150">
                                    <div class="centrado1 max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">Camargo</div></li>
                                </li>
                                    <li><img src="imagen/foto.jpeg" height="300" width="150">
                                    <div class="centrado2 max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">Tarija</div></li>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Potosi</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Camargo</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Tarija</h4>
    ...
    <!-- servicios Section -->
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-20 xl:px-0">

        <div id="servicios" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h3
                class="w-full max-w-2xl px-5 px-8 mt-2 text-2xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl md:px-0">
            ...
            <div class="max-w-full mx-auto md:max-w-6xl sm:px-8">
                ...
                <div class="relative flex flex-col items-center sm:flex-row">
                    <div
                        class="relative z-0 w-11/12 max-w-sm my-8 border border-gray-400 rounded-lg sm:w-3/5 lg:w-1/3 sm:my-5 md:-mr-4">
                        <div class="overflow-hidden text-black bg-gray-200 border-t border-gray-100 rounded-lg shadow-sm">
                            <div
                                class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                                <h3 class="p-3 text-lg font-bold tracking-wide text-center uppercase">Transporte Interdepartamental<span
                                        class="ml-2 font-light"> </span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700"></span></h4>
                                <p class="text-sm text-gray-600">Expreso Tarija tiene una trayectoria de mas de medio 
                                siglo brindando el servicio de viajes interdepartamentales e interprovinciales en el 
                                Pais siendo asi pioneros en abrir rutas. 
                                </p>
                            </div>
                            ...
                            <div class="flex flex-wrap px-6 mt-8">
                                <ul>
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">Potosí - Camargo</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">Potosí - Tarija</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Encomiendas<span
                                    class="ml-2 font-light"> </span></h3>
                            <h4
                                class="flex items-center justify-center pb-6 text-5xl font-bold text-center text-gray-900">
                                <span class="mr-1 -ml-2 text-lg text-gray-700"></span></h4>
                            <p class="text-sm text-gray-600">Enviamos a todos nuestros destinos sus
                             encomiendas, giros, sobres, mudanzas, visite nuestras sucursales,
                              los esperamos!
                        ...
                        <div class="flex justify-start pl-12 mt-8 sm:justify-start">
                            <ul>
                                <li class="flex items-center">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">Camargo</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                        <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">Tarija</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                        <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">Yacuiba</span>
                                </li>
                                ...
                                <li class="flex items-center">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">Bermejo</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-gray-200 rounded-lg shadow-lg shadow-inner">
                            <div
                                class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-8">
                                <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Servicio de Contratación Transporte<span
                                        class="ml-2 font-light"></span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700"></span></h4>
                                <p class="pl-2 text-sm text-gray-600">Podemos brindarte el servicio de transporte interdepartamentales
                                para ti y para el grupo de personas con los que viajas, para adquirir este servicio
                                 contacte o escríbenos en la sección de burbuja de chat y nos pondremos en contacto contigo
                            ...
                            <div class="flex flex-wrap px-8 mt-8">
                                <ul>
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">Viaje de Promociones</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">Eventos y otros</span>
                                    </li>
                                </ul>
                            </div>
    ...
    <footer class="px-2 pt-12 pb-8 text-white bg-blue-300 border-t border-gray-200">
     
            <div class=" mx-4 sm:-mx-8 px-4 sm:px-8 overflow-x-auto py-2 block w-full pl-10 mt-6 text-sm lg:w-4/4 sm:flex lg:mt-0">
    
                <ul class="px-10 flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                
                    <li class="inline-block px-4 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        TARIJA 
                    </li>
                           
                    <li class="inline-block px-4 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        SUCURSAL 1 
                    </li>
            
                    <x-jet-nav-link class="px-4">
                ...
                <ul class=" flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    ...
                    <li class="inline-block px-3 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        SUCURSAL 2
                    </li>
                    
                    <x-jet-nav-link class="px-3">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    Calle Uruguay s/n
                    </x-jet-nav-link>
                    <li class="inline-block px-3 text-white no-underline">Terminal de buses
                    </li>
                    ...
                    <li class="inline-block px-3 text-white no-underline ">Entre Cornelio Rios
                    </li>
                ...
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    ...
                    <li class="inline-block px-3 text-white no-underline">Entre Backovick y Villarroel
                    </li>
                ...
                <ul class="px-2 flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        Potosi
                    </li>
                    <li class="inline-block px-3 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                    ...
                    <li class="inline-block px-3 text-white no-underline">Edif. Terminal de Buses
                    </li>
                ...
                <ul class=" px-3 flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        Santa Cruz
                    </li>
                    <li class="inline-block px-3 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                    ...
                    <x-jet-nav-link class="px-3">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    Av. Ismael Montes 3er anillo
                    </x-jet-nav-link>
                    <li class="inline-block px-3 text-white no-underline">Terminal Bimodal
                    </li>
                ...
                <ul class="px-4 flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        Sucre
                    </li>
                    <li class="inline-block px-3 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
        ...
        <div class=" pt-6 mt-10 bg-gray-800 text-center text-gray-50 border-t border-gray-100">© 2021 Empresa de Transporte Expreso Tarija.</div>
    </footer>
